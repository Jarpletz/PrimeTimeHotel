...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        try
        {
            BufferedImage icon = ImageIO.read(new File("src/main/java/com/raven/datechooser/forward.png"));
            Icon imageIcon = new ImageIcon(icon);
            cmdForward.setIcon(imageIcon);
        }
        catch (IOException e)
        {

        }
        //ImageIcon icon = new ImageIcon("src/main/java/com/raven/datechooser/forward.png");
        ...
        try
        {
            BufferedImage icon = ImageIO.read(new File("src/main/java/com/raven/datechooser/previous.png"));
            Icon imageIcon = new ImageIcon(icon);
            cmdPrevious.setIcon(imageIcon);
        }
        catch (IOException e)
        {
